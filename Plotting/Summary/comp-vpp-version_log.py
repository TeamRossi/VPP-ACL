...
def seed_interpol(seed_line):
	...
	x=[2, 10, 100, 500, 1000, 2000, 4000, 8000, 16000, 32000]
	min_x=min(x)
	max_x=max(x)
	print(str(x))
	y=seed_line
...
#ax.semilogy(x1a, seed1a, '--C0', label='VPP 17.04')
#ax.semilogy(x2a, seed2a, '--C3', label='VPP 17.10')
#ax.semilogy(x3a, seed3a, '--C2', label='VPP 17.10 - TupleMerge')

ax.loglog(x1a, seed1a, '--C0', label='VPP 17.04', basex=2)
ax.loglog(x2a, seed2a, '--C3', label='VPP 17.10', basex=2)
ax.loglog(x3a, seed3a, '--C2', label='VPP 17.10 - TupleMerge', basex=2)
...
ax2.loglog(x1b, seed1b, '--C0', label='VPP 17.04', basex=2)
ax2.loglog(x2b, seed2b, '--C3', label='VPP 17.10', basex=2)
ax2.loglog(x3b, seed3b, '--C2', label='VPP 17.10 - TupleMerge', basex=2)
