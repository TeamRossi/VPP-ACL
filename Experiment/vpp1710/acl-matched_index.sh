...
sudo $MOONGEN_PATH/build/MoonGen $MGSCR/tr_gen_shot.lua --dpdk-config=$CONFIG_DIR/dpdk-conf.lua 1 0 $RULESET/trace_shot/$dir/$tfilename > $EXP_RES/results_$dts/Index/MG_$name_exp.out
...
mv $EXP_RES/results_$dts/Index/* $EXP_RES/results_$dts/Index_$dts/
