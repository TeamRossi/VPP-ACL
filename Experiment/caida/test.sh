...
#sudo -E $BINS/vppctl -s /tmp/cli.sock acl-plugin add filename /home/valerio/Ruleset/4k_1/acl1_seed_1.rules
#sudo -E $BINS/vppctl -s /tmp/cli.sock acl-plugin add filename /home/valerio/Ruleset/16k_1/acl3_seed_1.rules
sudo -E $BINS/vppctl -s /tmp/cli.sock acl-plugin add filename /home/valerio/Ruleset/8k_1/acl1_seed_1.rules

echo "Applying rules"
sudo -E $BINS/vppctl -s /tmp/cli.sock acl-plugin apply sw_if_index 2 input 0 
#sudo -E $BINS/vppctl -s /tmp/cli.sock acl-plugin apply sw_if_index 1 input 1 2
