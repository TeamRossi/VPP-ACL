...
ax.plot(x1a, seed1a, '--C0', label='NoPortRange Ruleset')
ax.plot(x2a, seed2a, '--C3', label='Original Ruleset')
...
ax2.plot(x1b, seed1b, '--C0', label='NoPortRange Ruleset')
ax2.plot(x2b, seed2b, '--C3', label='Original Ruleset')
